...
## Data Analysis
- Still a bit uncertain about how to properly perform a linear regression analysis to examine the relationship between differentially abundant pathways and MoCA scores.
  - Should we conduct a literature review first to identify which differentially abundant pathways should be included in the analysis?
  - Consider about them individually or collectively?
